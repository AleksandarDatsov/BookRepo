...
namespace BookStore.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LanguageController : BookStore.Controllers.LanguageController
    {
        ...
        [NonAction]
        partial void ChangeOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string lang);

        [NonAction]
        public override System.Web.Mvc.ActionResult Change(string lang)
        {
